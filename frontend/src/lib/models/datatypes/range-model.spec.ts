...
describe('RangeModel', () => {
  ...
  describe('display', () => {
    it('returns the correct display when there is only a low', () => {
      const range = new RangeModel({ low: quantityR4Factory.value(6.2).build() })
      const range2 = new RangeModel({ low: quantityR4Factory.value(6.2).unit('g').build() })
    ...
    it('returns the correct display when there is only a high', () => {
      const range = new RangeModel({ high: quantityR4Factory.value(6.2).build() })
      const range2 = new RangeModel({ high: quantityR4Factory.value(6.2).unit('g').build() })
    ...
    it('returns the correct display when there both a high and low', () => {
      const range = new RangeModel({ low: quantityR4Factory.value(6.2).build(), high: quantityR4Factory.value(8.9).build() })
      const range2 = new RangeModel({ low: quantityR4Factory.value(6.2).unit('g').build(), high: quantityR4Factory.value(8.9).unit('g').build() })
