...
const r4Example1DisplayModel =  new ProcedureModel(R4Example1Json, fhirVersions.R4)
...
const r4Example2DisplayModel =  new ProcedureModel(R4Example2Json, fhirVersions.R4)
...
const r4Example3DisplayModel =  new ProcedureModel(R4Example3Json, fhirVersions.R4)
