...
const r4Example1DisplayModel =  new PractitionerModel(R4Example1Json, fhirVersions.R4)
...
const r4Example2DisplayModel =  new PractitionerModel(R4Example2Json, fhirVersions.R4)
...
const r4Example3DisplayModel =  new PractitionerModel(R4Example3Json, fhirVersions.R4)
